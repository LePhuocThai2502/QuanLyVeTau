...
public class ChuyenTau {
	...
	public ChuyenTau(String maChuyenTau, String tenChuyenTau, Date ngayDi, Date ngayDen, Time gioKhoiHanh, Time gioDen,
			String gaDi, String gaDen, int soLuongVe) {
		super();
	...
	public String toString() {
		return "ChuyenTau [maChuyenTau=" + maChuyenTau + ", tenChuyenTau=" + tenChuyenTau + ", ngayDi=" + ngayDi
				...
				+ ", gaDen=" + gaDen + ", soLuongVe=" + soLuongVe + "]";
	}
